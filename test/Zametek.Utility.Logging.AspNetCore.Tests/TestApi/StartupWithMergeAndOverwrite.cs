...
{
    public class StartupWithMergeAndOverwrite
        : StartupBase
    {
        public StartupWithMergeAndOverwrite(IConfiguration configuration)
            : base(configuration)
        {
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseOverwriteTrackingContextHeaderMiddleware(CountryOfOriginName, @"France");
